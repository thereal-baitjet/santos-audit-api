  ...
  return (
    <PageShell>
      ...
      <article className="article-page methodology-page">
        ...
        <section className="content-section related"><h2>Inspect the implementation</h2><div className="related-links"><a href="/reports/sample-agent-readiness">View a sample report →</a><a href="/openapi.json">Read the OpenAPI contract →</a><a href="/agent-readiness-audit#run-audit">Run an Agent Readiness audit →</a></div></section>
      </article>
    </PageShell>
  );
}
