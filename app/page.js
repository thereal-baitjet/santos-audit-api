...
const homepageJsonLd = {
  ...
  offers: [
    { "@type": "Offer", name: "Quick Intelligence Audit", price: "0.005", priceCurrency: "USDC" },
    { "@type": "Offer", name: "Agent Readiness Audit", price: readinessPrice, priceCurrency: "USDC" },
    { "@type": "Offer", name: "Deep Website Intelligence Audit", price: process.env.DEEP_AUDIT_PRICE_USDC ?? "0.075", priceCurrency: "USDC" },
  ],
};
  ...
  return (
    <PageShell>
      ...
      <header className="hero">
        <div className="hero-copy">
          ...
          <div className="cta-row">
            <a className="btn primary" href="#audit" data-analytics-event="primary_cta_clicked">Run an Agent Readiness Audit</a>
            <a className="btn" href="/website-intelligence-api" data-analytics-event="api_documentation_viewed">Explore the API</a>
          </div>
      ...
      <div className="home-content">
        ...
        <section className="content-section audit" id="audit"><p className="section-label">08 · Live entry point</p><h2>Audit a public page in seconds</h2><p className="sub wide">Start with one free Quick Intelligence scan to inspect the report shape. Use the paid Agent Readiness endpoint for bounded interface discovery and applicability-aware evidence.</p><div className="audit-box"><AuditWidget /></div></section>

        <section className="content-section" id="pricing" data-analytics-event="pricing_viewed"><p className="section-label">09 · Transparent pricing</p><h2>Pay per audit, not per seat</h2><p className="sub wide">No subscription and no traditional API key. x402 terms are returned before payment, and the audited target is never paid by Santos during discovery.</p><div className="plan-grid"><article className="plan"><div className="plan-head"><h3>Quick Intelligence</h3><div className="plan-price">$0.005 <span>USDC / success</span></div><div className="plan-mode">GET /api/audit</div></div><p className="plan-pitch">Fast single-page performance, SEO, accessibility markup, security, and structured fixes.</p></article><article className="plan plan--agent"><div className="plan-head"><h3>Agent Readiness</h3><div className="plan-price">${readinessPrice} <span>USDC / success</span></div><div className="plan-mode">GET /api/agent-readiness</div></div><p className="plan-pitch">Bounded passive discovery of agent documentation, identity, OpenAPI, MCP, trust, and commerce.</p></article><article className="plan plan--deep"><div className="plan-head"><h3>Deep Intelligence</h3><div className="plan-price">$0.075 <span>USDC / reservation</span></div><div className="plan-mode">POST /v1/audits</div></div><p className="plan-pitch">Browser-rendered Lighthouse, axe-core, screenshots, network evidence, and passive security.</p></article></div><div className="cta-row"><a className="btn primary" href="#audit">Run an Agent Readiness Audit</a><a className="btn" href="/website-intelligence-api">Integrate the API</a></div></section>
