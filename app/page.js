  ...
  return (
    <PageShell>
      ...
      <div className="home-content">
        ...
        <section className="content-section split-section" id="about"><div><p className="section-label">About the builder</p><h2>Built by an engineer who cares about the result</h2><p className="sub wide">Santos Automation is built and operated by <strong>Juan Santos</strong>, an independent engineer focused on making the web easier for people and AI agents to use.</p><p className="sub wide">After years working hands-on in field technology and sales, Juan taught himself software engineering and began shipping real products—not tutorials or prototypes. Since 2020, he has built and launched more than 100 public projects, including e-commerce systems with live payments, automation tools, AI-powered web products, and developer APIs.</p><p className="sub wide">Santos Website Intelligence is the result of that work: practical infrastructure that helps teams see whether their website can be discovered, understood, trusted, and used by modern AI agents.</p><p className="sub wide">This is not a pitch deck. It is production software with real public contracts, machine-readable documentation, verifiable reports, and pay-per-use infrastructure.</p><p className="sub wide">No ticket queue. No account manager. When you contact Santos, you reach the engineer who built it.</p><div className="inline-links" aria-label="Founder links"><a href="https://github.com/thereal-baitjet" rel="me">GitHub</a><a href="https://www.linkedin.com/in/santosjuanc/" rel="me">LinkedIn</a><a href="mailto:info@santosautomation.com">info@santosautomation.com</a></div></div><img className="about-portrait" src="/assets/santos-portrait.png" alt="Portrait of Juan Santos, founder and engineer of Santos Automation" width="1086" height="1448" loading="lazy" /></section>
