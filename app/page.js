  ...
  return (
    <PageShell>
      ...
      <div className="stat-strip">
        <div className="wrap">
          <div className="stat"><b>8</b><span>paid capabilities</span></div>
