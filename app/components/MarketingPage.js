      ...
      <article className="marketing-page">
        ...
        <header className="page-hero">
          ...
          <div className="cta-row">
            ...
            <a className="btn" href="#see-reports" data-analytics-event="see_reports_clicked">See a Real Report</a>
        ...
        <section id="see-reports" className="content-section"><h2>Read a real report first</h2><p className="sub">Every domain below was audited with the production engine — same scores, same evidence, same prioritized fixes you would be buying. The Quick API costs {apiProduct("/api/audit").priceUsdc} USDC per successful audit, and the complete <a href="/agent-readiness/run">Agent Readiness audit</a> costs {apiProduct("/api/agent-readiness").priceUsdc} USDC per successful audit.</p><div className="audit-box"><AuditWidget /></div></section>
