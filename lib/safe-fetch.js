...
async function readCapped(res) {
  ...
  if (declared && declared > MAX_RESPONSE_BYTES) {
    throw new AuditError("RESPONSE_TOO_LARGE", `Response exceeds ${MAX_RESPONSE_BYTES} byte limit`);
  }
...
export async function safeFetch(rawUrl, headers) {
  ...
  throw new AuditError("TOO_MANY_REDIRECTS", `Exceeded ${MAX_REDIRECTS} redirects`);
}
