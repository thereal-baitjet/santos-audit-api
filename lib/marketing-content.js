...
export const PRODUCT_PAGES = {
  ...
  "agent-readiness-audit": {
    ...
    description: "Audit whether AI agents can discover, understand, and use a website's public machine interfaces. Applicability-aware results cost 0.025 USDC via x402.",
    eyebrow: "Paid capability · 0.025 USDC per successful audit",
  ...
  "website-intelligence-api": {
    ...
    highlights: [
      { name: "Quick Intelligence", text: "GET /api/audit · synchronous · 0.005 USDC per successful audit." },
      { name: "Agent Readiness", text: "GET /api/agent-readiness · synchronous · 0.025 USDC per successful audit." },
      { name: "Deep Intelligence", text: "POST /v1/audits · asynchronous · 0.075 USDC per bounded compute reservation." },
    ],
