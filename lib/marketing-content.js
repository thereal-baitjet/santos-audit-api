...
export const LEARN_ARTICLES = {
  "what-is-ai-website-intelligence": {
    ...
    sections: [
      ...
      ["Callable, made concrete", "Santos is itself an example of the callable dimension it measures: seven x402-payable capabilities on Base mainnet, each documented in OpenAPI, discoverable through llms.txt and MCP, and priced explicitly rather than hidden behind a subscription. A Quick Intelligence Audit ($0.015) and Agent Readiness assessment ($0.075) triage a page; Safe Fetch ($0.002), Page-to-Markdown Extraction ($0.005), and Structured Extraction ($0.08) turn a page into raw text, clean Markdown, or schema-conforming JSON; Screenshot & PDF Render ($0.01) captures what a real browser sees; a Deep Website Intelligence Audit ($0.225) adds Lighthouse, axe-core, and network evidence. Every one settles USDC only after a successful response — a payable interface an agent can select, invoke, and trust without a support ticket."],
    ],
  },
