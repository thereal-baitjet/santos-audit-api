import { INDEX_STATS } from "./index-stats.js";
...
export const LEARN_ARTICLES = {
  ...
  "what-200-audits-reveal": {
    title: `What ${INDEX_STATS.auditedSiteCountLabel} Audits of the World's Biggest Sites Reveal`, description: `Methodology and findings from auditing more than 300 well-known websites with one deterministic engine: average ${INDEX_STATS.averageScore}, median ${INDEX_STATS.medianScore}, and the patterns behind the scores.`,
    intro: "Santos ran the same deterministic audit across more than 300 well-known websites. The result is a public index of how ready the web's most visited properties actually are for AI agents, and the picture is mixed.",
    sections: [
      ...
      ["Headline numbers", `Across the index the average score is ${INDEX_STATS.averageScore} out of 100 and the median is ${INDEX_STATS.medianScore}. The top score belongs to ${INDEX_STATS.topDomain} at ${INDEX_STATS.topScore}. At the other end sit some of the most visited properties on the web: google.com at 39, oracle.com at 39, and binance.com at 24. A median in the high fifties means the typical major site is discoverable and readable, but offers an agent almost nothing it can reliably call or verify.`],
      ...
      ["The other pattern: consumer and finance score low", "Large consumer platforms and finance sites cluster at the bottom. Their real interfaces sit behind accounts, session auth, and app stores; their robots directives are restrictive; and their machine-facing documentation is sparse or marketing-led. Google's 39 is a useful reminder that size and engineering talent do not automatically produce agent-readiness — the surfaces an agent needs are simply not the surfaces these businesses expose."],
