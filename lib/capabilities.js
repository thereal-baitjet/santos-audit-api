...
export function capabilityManifest() {
  ...
  return {
    ...
    capabilities: [
      ...
      {
        id: "agent-readiness.quick", title: "Agent Readiness Audit", version: "1.0.0", description: "Select to assess public agent-facing discovery, APIs, MCP, trust, and machine-commerce interfaces without active target actions.",
