...
export function capabilityManifest() {
  ...
  return {
    ...
    human_purchase: {
      ...
      note: "Human convenience: one-time card purchase, emailed as a private tokened link, no account. The machine-payable per-call price remains $0.025 USDC via x402.",
    },
